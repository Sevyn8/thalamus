...
class QuarantinedRow(Base):
    ...
    # via the inline identity_mirror.stores join in repos/quarantine.py (no store-name column).
    ...
    # CHECK ck_qr_status_vocab: NEW | RESOLVED | DISMISSED; 11a writes NEW only.
