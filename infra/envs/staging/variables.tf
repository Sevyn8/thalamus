...
variable "cm_frontend_image" {
  ...
  default     = "asia-south1-docker.pkg.dev/sevyn8-thalamus-staging/thalamus-images/cm-frontend:v22"
}
...
variable "synapse_ui_server_image" {
  ...
  default     = "asia-south1-docker.pkg.dev/sevyn8-thalamus-staging/thalamus-images/synapse-ui-server:v3"
}
...
variable "synapse_orchestrator_image" {
  ...
  default     = "asia-south1-docker.pkg.dev/sevyn8-thalamus-staging/thalamus-images/synapse-orchestrator:v4"
}
