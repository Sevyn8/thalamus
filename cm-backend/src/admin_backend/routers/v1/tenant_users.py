...
# The explicit POST /me/accept-invitation endpoint (D-40) was retired: with
# implicit reconciliation on the first authenticated /me/permissions call
# (TenantUsersRepo.reconcile_acceptance_on_login), a valid CM token for a
# TENANT user IS acceptance, and nothing referenced the endpoint. The repo
# method accept_invitation stays: reconciliation delegates to it.
