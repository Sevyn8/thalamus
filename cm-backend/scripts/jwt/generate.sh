#!/usr/bin/env bash
# Generate a JWT for a given user and save to a file.
# Usage:
#   ./scripts/jwt/generate.sh anjali@ithina.ai      # platform user
#   ./scripts/jwt/generate.sh marcus@bucees.com     # tenant user
#
# Outputs to scripts/jwt/tokens/<email-prefix>.jwt
...
OUTFILE="scripts/jwt/tokens/${EMAIL_PREFIX}.jwt"
echo "$JWT" > "$OUTFILE"
