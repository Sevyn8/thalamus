...
// Phase 5f.W.2: /me/can-do hook. Per Sanjeev's design intent
// (docs/endpoints/me.md): "call before a high-stakes action where
// cascade-aware verification matters... avoids the user clicking
...
//
// v0 demo expedient: in-flight click during /me/can-do load bypasses
// the gate (data is undefined, !== false). Acceptable per Sanjeev's
// server-side-enforcement-is-the-boundary framing. Closing the bypass
// requires button-disable on isLoading (flicker risk) or click-queue
// (added complexity). Deferred to Phase 5g+ if a use case demands
// tighter gating. See Architectural Finding #20.
//
