...
// Slice 5 (Access & users): first frontend wiring of the Auth0
// provisioning + invitation endpoints. Server-wait mutations (no
// optimistic UI), matching the codebase convention.
