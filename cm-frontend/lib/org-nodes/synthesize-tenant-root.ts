...
// Shared helper for synthesizing the tenant-
...
//
// Used by:
//   - components/org/OrgTree.tsx     — /superadmin/org page
...
// anchor-required surface. Routing consumers through this helper is
// what makes OrgNodePicker's dead-end "No org nodes configured" empty
// state unreachable.
//
// CreateStoreModal uses its own inline `flattenParents` for a flat
// `<select>` rendering and does not consume this helper. The concept
// is the same; the rendering shape differs.
